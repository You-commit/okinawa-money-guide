...
const policies = [
  ...
  { id: 'ads', number: '05', title: '広告・提携と利益相反への考え方', english: 'Advertising & Partnership', tag: '判断優先', body: '沖縄マネーガイドでは、一部のページでアフィリエイト広告を利用する場合があります。リンクを経由して申込み等が行われると運営者が報酬を受け取ることがありますが、広告報酬の有無によってシミュレーション結果や制度説明を変更することはありません。' },
] as const
        ...
        <div className="info-main"><div className="info-shell">
          ...
          <section className="info-section"><div className="trust-layout">
            ...
            <div className="policy-stack">
              ...
              <article className="data-pledge info-surface" id="privacy"><p className="info-eyebrow">DATA PROMISE</p><h2>入力した金額や計算結果を、広告のために外部へ提供しません。</h2><p>利用者が安心して試算できることを優先し、入力した金額や計算結果を広告主や提携先へ提供しません。取得する情報がある場合は、目的と範囲を分かりやすく示します。</p><div><span>入力した金額を広告主へ提供しない</span><span>計算結果を提携先へ提供しない</span><span>必要以上の個人情報を求めない</span></div></article>
